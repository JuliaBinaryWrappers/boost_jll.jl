# Autogenerated wrapper script for boost_jll for x86_64-apple-darwin14-cxx03
export libboost_math_tr1f, libboost_serialization, libboost_context, libboost_wserialization, libboost_iostreams, libboost_graph, libboost_chrono, libboost_math_c99, libboost_regex, libboost_system, libboost_coroutine, libboost_stacktrace_noop, libboost_container, libboost_math_c99f, libboost_math_tr1, libboost_stacktrace_basic, libboost_timer, libboost_log, libboost_prg_exec_monitor, libboost_type_erasure, libboost_math_tr1l, libboost_unit_test_framework, libboost_contract, libboost_log_setup, libboost_atomic, libboost_math_c99l, libboost_program_options, libboost_random, libboost_date_time, libboost_wave, libboost_thread, libboost_filesystem
...
const libboost_math_tr1f_splitpath = ["lib", "libboost_math_tr1f.dylib"]
...
const libboost_math_tr1f = "@rpath/libboost_math_tr1f.dylib"


# Relative path to `libboost_serialization`
const libboost_serialization_splitpath = ["lib", "libboost_serialization.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_serialization = "@rpath/libboost_serialization.dylib"


# Relative path to `libboost_context`
const libboost_context_splitpath = ["lib", "libboost_context.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_context = "@rpath/libboost_context.dylib"


# Relative path to `libboost_wserialization`
const libboost_wserialization_splitpath = ["lib", "libboost_wserialization.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_wserialization = "@rpath/libboost_wserialization.dylib"


# Relative path to `libboost_iostreams`
const libboost_iostreams_splitpath = ["lib", "libboost_iostreams.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_iostreams = "@rpath/libboost_iostreams.dylib"


# Relative path to `libboost_graph`
const libboost_graph_splitpath = ["lib", "libboost_graph.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_graph = "@rpath/libboost_graph.dylib"


# Relative path to `libboost_chrono`
const libboost_chrono_splitpath = ["lib", "libboost_chrono.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_chrono = "@rpath/libboost_chrono.dylib"


# Relative path to `libboost_math_c99`
const libboost_math_c99_splitpath = ["lib", "libboost_math_c99.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_math_c99 = "@rpath/libboost_math_c99.dylib"


# Relative path to `libboost_regex`
const libboost_regex_splitpath = ["lib", "libboost_regex.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_regex = "@rpath/libboost_regex.dylib"


# Relative path to `libboost_system`
const libboost_system_splitpath = ["lib", "libboost_system.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_system = "@rpath/libboost_system.dylib"


# Relative path to `libboost_coroutine`
const libboost_coroutine_splitpath = ["lib", "libboost_coroutine.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_coroutine = "@rpath/libboost_coroutine.dylib"


# Relative path to `libboost_stacktrace_noop`
const libboost_stacktrace_noop_splitpath = ["lib", "libboost_stacktrace_noop.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_stacktrace_noop = "@rpath/libboost_stacktrace_noop.dylib"


# Relative path to `libboost_container`
const libboost_container_splitpath = ["lib", "libboost_container.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_container = "@rpath/libboost_container.dylib"


# Relative path to `libboost_math_c99f`
const libboost_math_c99f_splitpath = ["lib", "libboost_math_c99f.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_math_c99f = "@rpath/libboost_math_c99f.dylib"


# Relative path to `libboost_math_tr1`
const libboost_math_tr1_splitpath = ["lib", "libboost_math_tr1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_math_tr1 = "@rpath/libboost_math_tr1.dylib"


# Relative path to `libboost_stacktrace_basic`
const libboost_stacktrace_basic_splitpath = ["lib", "libboost_stacktrace_basic.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_stacktrace_basic = "@rpath/libboost_stacktrace_basic.dylib"


# Relative path to `libboost_timer`
const libboost_timer_splitpath = ["lib", "libboost_timer.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_timer = "@rpath/libboost_timer.dylib"


# Relative path to `libboost_log`
const libboost_log_splitpath = ["lib", "libboost_log.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_log = "@rpath/libboost_log.dylib"


# Relative path to `libboost_prg_exec_monitor`
const libboost_prg_exec_monitor_splitpath = ["lib", "libboost_prg_exec_monitor.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_prg_exec_monitor = "@rpath/libboost_prg_exec_monitor.dylib"


# Relative path to `libboost_type_erasure`
const libboost_type_erasure_splitpath = ["lib", "libboost_type_erasure.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_type_erasure = "@rpath/libboost_type_erasure.dylib"


# Relative path to `libboost_math_tr1l`
const libboost_math_tr1l_splitpath = ["lib", "libboost_math_tr1l.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_math_tr1l = "@rpath/libboost_math_tr1l.dylib"


# Relative path to `libboost_unit_test_framework`
const libboost_unit_test_framework_splitpath = ["lib", "libboost_unit_test_framework.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_unit_test_framework = "@rpath/libboost_unit_test_framework.dylib"


# Relative path to `libboost_contract`
const libboost_contract_splitpath = ["lib", "libboost_contract.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_contract = "@rpath/libboost_contract.dylib"


# Relative path to `libboost_log_setup`
const libboost_log_setup_splitpath = ["lib", "libboost_log_setup.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_log_setup = "@rpath/libboost_log_setup.dylib"


# Relative path to `libboost_atomic`
const libboost_atomic_splitpath = ["lib", "libboost_atomic.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_atomic = "@rpath/libboost_atomic.dylib"


# Relative path to `libboost_math_c99l`
const libboost_math_c99l_splitpath = ["lib", "libboost_math_c99l.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_math_c99l = "@rpath/libboost_math_c99l.dylib"


# Relative path to `libboost_program_options`
const libboost_program_options_splitpath = ["lib", "libboost_program_options.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_program_options = "@rpath/libboost_program_options.dylib"


# Relative path to `libboost_random`
const libboost_random_splitpath = ["lib", "libboost_random.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_random = "@rpath/libboost_random.dylib"


# Relative path to `libboost_date_time`
const libboost_date_time_splitpath = ["lib", "libboost_date_time.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_date_time = "@rpath/libboost_date_time.dylib"


# Relative path to `libboost_wave`
const libboost_wave_splitpath = ["lib", "libboost_wave.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_wave = "@rpath/libboost_wave.dylib"


# Relative path to `libboost_thread`
const libboost_thread_splitpath = ["lib", "libboost_thread.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_thread = "@rpath/libboost_thread.dylib"


# Relative path to `libboost_filesystem`
const libboost_filesystem_splitpath = ["lib", "libboost_filesystem.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libboost_filesystem = "@rpath/libboost_filesystem.dylib"
...
"""
function __init__()
    global artifact_dir = abspath(artifact"boost")

    # Initialize PATH and LIBPATH environment variable listings
    global PATH_list, LIBPATH_list
    # We first need to add to LIBPATH_list the libraries provided by Julia
    append!(LIBPATH_list, [joinpath(Sys.BINDIR, Base.LIBDIR, "julia"), joinpath(Sys.BINDIR, Base.LIBDIR)])
    global libboost_math_tr1f_path = normpath(joinpath(artifact_dir, libboost_math_tr1f_splitpath...))
    ...
    global libboost_serialization_path = normpath(joinpath(artifact_dir, libboost_serialization_splitpath...))
    ...
    global libboost_context_path = normpath(joinpath(artifact_dir, libboost_context_splitpath...))
    ...
    global libboost_wserialization_path = normpath(joinpath(artifact_dir, libboost_wserialization_splitpath...))
    ...
    global libboost_iostreams_path = normpath(joinpath(artifact_dir, libboost_iostreams_splitpath...))
    ...
    global libboost_graph_path = normpath(joinpath(artifact_dir, libboost_graph_splitpath...))
    ...
    global libboost_chrono_path = normpath(joinpath(artifact_dir, libboost_chrono_splitpath...))
    ...
    global libboost_math_c99_path = normpath(joinpath(artifact_dir, libboost_math_c99_splitpath...))
    ...
    global libboost_regex_path = normpath(joinpath(artifact_dir, libboost_regex_splitpath...))
    ...
    global libboost_system_path = normpath(joinpath(artifact_dir, libboost_system_splitpath...))
    ...
    global libboost_coroutine_path = normpath(joinpath(artifact_dir, libboost_coroutine_splitpath...))
    ...
    global libboost_stacktrace_noop_path = normpath(joinpath(artifact_dir, libboost_stacktrace_noop_splitpath...))
    ...
    global libboost_container_path = normpath(joinpath(artifact_dir, libboost_container_splitpath...))
    ...
    global libboost_math_c99f_path = normpath(joinpath(artifact_dir, libboost_math_c99f_splitpath...))
    ...
    global libboost_math_tr1_path = normpath(joinpath(artifact_dir, libboost_math_tr1_splitpath...))
    ...
    global libboost_stacktrace_basic_path = normpath(joinpath(artifact_dir, libboost_stacktrace_basic_splitpath...))
    ...
    global libboost_timer_path = normpath(joinpath(artifact_dir, libboost_timer_splitpath...))
    ...
    global libboost_log_path = normpath(joinpath(artifact_dir, libboost_log_splitpath...))
    ...
    global libboost_prg_exec_monitor_path = normpath(joinpath(artifact_dir, libboost_prg_exec_monitor_splitpath...))
    ...
    global libboost_type_erasure_path = normpath(joinpath(artifact_dir, libboost_type_erasure_splitpath...))
    ...
    global libboost_math_tr1l_path = normpath(joinpath(artifact_dir, libboost_math_tr1l_splitpath...))
    ...
    global libboost_unit_test_framework_path = normpath(joinpath(artifact_dir, libboost_unit_test_framework_splitpath...))
    ...
    global libboost_contract_path = normpath(joinpath(artifact_dir, libboost_contract_splitpath...))
    ...
    global libboost_log_setup_path = normpath(joinpath(artifact_dir, libboost_log_setup_splitpath...))
    ...
    global libboost_atomic_path = normpath(joinpath(artifact_dir, libboost_atomic_splitpath...))
    ...
    global libboost_math_c99l_path = normpath(joinpath(artifact_dir, libboost_math_c99l_splitpath...))
    ...
    global libboost_program_options_path = normpath(joinpath(artifact_dir, libboost_program_options_splitpath...))
    ...
    global libboost_random_path = normpath(joinpath(artifact_dir, libboost_random_splitpath...))
    ...
    global libboost_date_time_path = normpath(joinpath(artifact_dir, libboost_date_time_splitpath...))
    ...
    global libboost_wave_path = normpath(joinpath(artifact_dir, libboost_wave_splitpath...))
    ...
    global libboost_thread_path = normpath(joinpath(artifact_dir, libboost_thread_splitpath...))
    ...
    global libboost_filesystem_path = normpath(joinpath(artifact_dir, libboost_filesystem_splitpath...))
